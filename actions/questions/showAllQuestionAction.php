...
$getAllQuestions = $bdd->query('SELECT id, id_author, title, description, content, pseudo_author, date_publication FROM questions ORDER BY id DESC LIMIT 0,5');  // ordre décroissant , limite de 5 questions affichées 
